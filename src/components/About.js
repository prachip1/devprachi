...
export default function About() {
    return(
        <section id="about" className="text-pink-light">
         ...
         <span className="text-5xl text-white bg-gradient-to-r from-pink-dark  via-blue-dark to-blue-light text-transparent bg-clip-text lg:inline-block md-tracking-widest ">DEVELOPER PORTFOLIO</span>
